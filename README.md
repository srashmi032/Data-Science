...
2.Getting data information like number of rows and columns, their datatypes, mean, median and mode of all columns, findind correlation and plotting graphs 
